...
At each step of the simulation, each vehicle in the system is stepped as well.

- Roads contain a set of vehicles (a subset of those of the system) by their licence plate, as well as some attributes such as length and connections, a name and a pointer to the roadsystem it is a part of.
